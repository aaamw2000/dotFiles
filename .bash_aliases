...
alias upp='sudo zypper refresh; sudo zypper update' # update installed packages

alias inp='sudo zypper refresh; sudo zypper update; sudo zypper install' # install a package without breaking  your system :D
